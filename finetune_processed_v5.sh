#!/bin/bash
#SBATCH --job-name=op_real
#SBATCH --output=jobs/op_real.%j.out
#SBATCH --error=jobs/op_real.%j.err
...
uv run scripts/train.py pi0_processed_v5_low_mem_finetune --exp-name=processed_v5-ft-run1 --batch_size=64 --num_train_steps=45001 --keep_period=15000 --resume
